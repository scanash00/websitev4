        ...
        <section id="top" className="flex min-h-screen w-full flex-col items-center justify-center px-4 sm:px-6 relative overflow-hidden">
          ...
          >
            ...
            >
              ...
              <motion.h1 
                className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-bold tracking-tight mb-4 relative text-center"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                >
                  ...
                  <div className="relative p-6 sm:p-8 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm hover:border-white/20 transition-colors duration-500">
                    ...
                    <p className="text-white/70 text-sm sm:text-base mb-4">
                      A fully made website by myself, no templates, just full myself. Built with Next.js, TypeScript, and Tailwind CSS.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/20">Next.js</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-cyan-500/10 text-cyan-300 border border-cyan-500/20">TypeScript</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-fuchsia-500/10 text-fuchsia-300 border border-fuchsia-500/20">Tailwind CSS</span>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="relative p-6 sm:p-8 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm hover:border-white/20 transition-colors duration-500">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/20">Astro</span>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="relative p-6 sm:p-8 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm hover:border-white/20 transition-colors duration-500">
                    ...
                    <p className="text-white/70 text-sm sm:text-base mb-4">
                      Second version of Scan's Website, does not use frameworks, and is light. Link not available.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/20">HTML</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-cyan-500/10 text-cyan-300 border border-cyan-500/20">CSS</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-fuchsia-500/10 text-fuchsia-300 border border-fuchsia-500/20">JavaScript</span>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="relative p-6 sm:p-8 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm hover:border-white/20 transition-colors duration-500">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs rounded-full bg-violet-500/10 text-violet-300 border border-violet-500/20">Java</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-cyan-500/10 text-cyan-300 border border-cyan-500/20">Spigot</span>
                      <span className="px-2 py-1 text-xs rounded-full bg-fuchsia-500/10 text-fuchsia-300 border border-fuchsia-500/20">MySQL</span>
                    </div>
                  </div>
                </motion.div>
              </div>
